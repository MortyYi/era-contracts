    ...
    values: [
      {
        ...
        initialProtocolVersion: BigNumberish;
      }
    ]
  ): string;
...
export class DiamondInit extends Contract {
  ...
  functions: {
    ...
    "initialize((address,address,address,bytes32,uint64,bytes32,(bytes32,bytes32,bytes32),bool,bytes32,bytes32,uint256,uint256))"(
      _initalizeData: {
        verifier: string;
        governor: string;
        admin: string;
