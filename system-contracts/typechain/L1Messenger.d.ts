...
interface L1MessengerInterface extends ethers.utils.Interface {
  functions: {
    "publishPubdataAndClearState(bytes)": FunctionFragment;
...
export class L1Messenger extends Contract {
  ...
  functions: {
    ...
    "publishPubdataAndClearState(bytes)"(
      _totalL2ToL1PubdataAndStateDiffs: BytesLike,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
